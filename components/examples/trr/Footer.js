    ...
    <div>
      ...
      <div className="border-t border-gray-300 py-12 ">
        <p className="container mx-auto text-sm px-12">
          All items are pre-owned and consigned to The RealReal. Trademarks are
          owned by their respective brand owners. No brand owner endorses or
          sponsors this ad or has any association and/or affiliation with The
          RealReal.
        </p>
      </div>
    </div>
