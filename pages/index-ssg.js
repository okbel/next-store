        ...
        <main className="container mx-auto relative py-6 px-10">
          ...
          <div className="px-3 py-6 border-t border-gray-300 mt-12 text-gray-600">
            *Promotional code will expire seven days from issue date. Code is
            ...
            purchased with the use of a code will result in the activation of
            the code, which will be valid for the following three days.
          </div>
        </main>
        <Footer></Footer>
        <div className="p-6 bg-white p-8 h-64 text-center flex flex-col justify-center items-center">
          <div className="m-4 p-4 md:flex md:items-center md:justify-between">
            <div className="flex md:order-2">
              ...
              <a href="#" className="ml-6 text-black hover:text-gray-300">
          ...
          <p className="py-3 ">
            Honoring heritage brands and extending the lifecycle of luxury
            items.
          </p>
          <small className="py-3">The RealReal, Inc.</small>
        </div>
        <div className="border-t border-gray-300 py-12 ">
          <p className="container mx-auto text-sm px-12">
            All items are pre-owned and consigned to The RealReal. Trademarks
            are owned by their respective brand owners. No brand owner endorses
            or sponsors this ad or has any association and/or affiliation with
            The RealReal.
          </p>
        </div>
      </div>
